...
int main(int argc, char *argv[])
{
	...
	c.green = 0;
	c.blue = 0;
	if (ioctl(fh, RGB_SET, &c) == -1) printf("14: fail\n");
	...
	c.green = 2047;
	c.blue = 2047;
	if (ioctl(fh, RGB_SET, &c) == -1) printf("15: fail\n");
	...
	c.green = 0;
	c.blue = 0;
	if (ioctl(fh, RGB_SET, &c) == -1) printf("16: fail\n");
	...
	c.green = 2047;
	c.blue = 0;
	if (ioctl(fh, RGB_SET, &c) == -1) printf("17: fail\n");
	...
	c.green = 0;
	c.blue = 2047;
	if (ioctl(fh, RGB_SET, &c) == -1) printf("18: fail\n");
